...
* Corresponding to these results, two csv files are extracted: [apps](business-apps.csv) and [app reviews](https://github.com/vedasam-ch15/Google-Play-Store-Data-Analysis/blob/05e30bbcca81fc93ef8046a90f90c6109400f1b1/reviews%20%20-%20outputfile%20(1).csv) <br/>
